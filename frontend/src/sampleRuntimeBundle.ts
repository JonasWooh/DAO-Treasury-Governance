    ...
    proposals: [
      {
        ...
        targets: [mockAddresses.funding, mockAddresses.treasury],
        values: ['0', '0'],
        calldatas: ['0xaaaa', '0xaaab'],
        ...
        expectedOutcome: {
          ...
          treasuryLiquidWeth: '3000000000000000000',
      ...
      },
      {
        ...
        targets: [mockAddresses.treasury, mockAddresses.funding],
        values: ['0', '0'],
        calldatas: ['0xcccc', '0xcccd'],
        ...
        workflow: {
          ...
          projectId: fundingProjectId,
          milestoneIndex: 0,
          evidenceURI: 'ipfs://campus-innovation-fund/sepolia/evidence/smart-recycling-kiosk/milestone-0',
        },
        expectedOutcome: {
